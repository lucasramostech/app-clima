...
function favoritosPressionado() {
    ...
    function favoritosLista() {
        const historic = document.querySelector('#historic')
        historic.innerHTML += `<button type="button" class="sub-favoritos rounded-xl min-h-[4rem] flex items-center justify-center font-serif text-white-600">${cidadeFavorita}</button>`
    }
}
